...
import com.snail.fitment.common.aop.ReflectUtils;
import com.snail.fitment.common.constants.RegisterConstants;
import com.snail.fitment.common.io.UnsafeStringWriter;
...
public final class StringUtils {
	...
	public static boolean isContains(String values, String value) {
		...
		return isContains(RegisterConstants.COMMA_SPLIT_PATTERN.split(values), value);
	}
	...
	public static String getServiceKey(Map<String, String> ps) {
		...
		String group = ps.get(RegisterConstants.GROUP_KEY);
		if (group != null && group.length() > 0) {
			buf.append(group).append("/");
		}
		buf.append(ps.get(RegisterConstants.INTERFACE_KEY));
		String version = ps.get(RegisterConstants.VERSION_KEY);
	...
	public static String toArgumentString(Object[] args) {
		...
		for (Object arg : args) {
			if (buf.length() > 0) {
				buf.append(RegisterConstants.COMMA_SEPARATOR);
			}
	...
	public static String stringExceptSpaces(String pinyin) {
