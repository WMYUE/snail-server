...
public final class URL implements Serializable {
	...
	public String getBackupAddress(int defaultPort) {
		...
		String[] backups = getParameter(RegisterConstants.BACKUP_KEY, new String[0]);
	...
	public String getParameter(String key) {
		...
		if (value == null || value.length() == 0) {
			value = parameters.get(RegisterConstants.DEFAULT_KEY_PREFIX + key);
		}
		return value;
	}
	...
	public String[] getParameter(String key, String[] defaultValue) {
		...
		return RegisterConstants.COMMA_SPLIT_PATTERN.split(value);
	}
	...
	public boolean isLocalHost() {
		return NetUtils.isLocalHost(host) || getParameter(RegisterConstants.LOCALHOST_KEY, false);
	}

	public boolean isAnyHost() {
		return RegisterConstants.ANYHOST_VALUE.equals(host) || getParameter(RegisterConstants.ANYHOST_KEY, false);
	}
	...
	public String getServiceKey() {
		...
		if (inf == null)
			return null;
		StringBuilder buf = new StringBuilder();
		String group = getParameter(RegisterConstants.GROUP_KEY);
		if (group != null && group.length() > 0) {
			buf.append(group).append("/");
		}
		buf.append(inf);
		String version = getParameter(RegisterConstants.VERSION_KEY);
	...
	public String getServiceInterface() {
		return getParameter(RegisterConstants.INTERFACE_KEY, path);
	}

	public URL setServiceInterface(String service) {
		return addParameter(RegisterConstants.INTERFACE_KEY, service);
	}
