...
public class RegisterConstants {
    ...
    public static final String  DEFAULT_DIRECTORY                  = "blueprint";

    public static final String  DEFAULT_LOADBALANCE                = "random";

    public static final String  DEFAULT_PROTOCOL                   = "blueprint";
    ...
    public static final String  DEFAULT_REMOTING_CODEC             = "blueprint";
    ...
    public static final String  DEFAULT_THREAD_NAME                = "BluePrint";
    ...
    public static final String  DEFAULT_REGISTRY                   = "blueprint";
