...
public final class CommonConstants {
	 public static final int STATUS_ALL=-1;
	    ...
	    public static final String DEFAULT_BLUEPRINT_DOMAIN_FLAG = "ALL";
	    public static final String DEFAULT_BLUEPRINT_ALL = "0000@";
	    
	    public static final String PLATFORM_TYPE_BLUEPRINT = "BLUEPRINT";
	    public static final String PLATFORM_TYPE_LANXIN = "LANXIN";
	    
	    public static final String OPENSERVICE_TYPE_HTTP = "lanxinHttpOpenService";
	    public static final String OPENSERVICE_TYPE_LANXIN = "lanxinOpenService";
	    public static final String OPENSERVICE_TYPE_BLUEPRINT = "blueprintOpenService";
	    public static final String OPENSERVICE_TYPE_MOCK = "mockLanxinOpenService";
