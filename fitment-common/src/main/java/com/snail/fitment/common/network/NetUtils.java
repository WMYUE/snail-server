...
import com.snail.fitment.common.collection.LRUCache;
...
public class NetUtils {
    ...
    public static Logger logger = Logger.getLogger(NetUtils.class);
    ...
    public static String getHostName(){
        try {
        	...
        	logger.debug("cannot get host info, error = " + e.getLocalizedMessage());
        	return "";
        }
    }
